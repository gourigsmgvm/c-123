...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		cv2.line(image, (fingertipx,fingertipy), (thumbtipx,thumbtipy), (0,255,0), 2)
		

		# Draw a CIRCLE on CENTER of the LINE between FINGER TIP and THUMB TIP
		cv2.circle(image,(centerx,centery),3,(255,0,0),2)
		

		# Calculate DISTANCE between FINGER TIP and THUMB TIP
		distance = math.sqrt((thumbtipx-fingertipx)**2 + (thumbtipy - fingertipy)**2)
